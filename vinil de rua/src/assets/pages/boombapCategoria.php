...
// Buscar produtos do gênero BOOMBAP
$stmt = $pdo->prepare("SELECT id, nome, autor, preco, img_link FROM produtos WHERE genero = 'BOOMBAP'");
$stmt->execute();
    ...
    <section class="fundoPrincipal">
        ...
        <section class="catalogoCategoria">
            ...
            <?php if (empty($produtos)): ?>
                ...
                <h2 style="text-align:center; margin-top:20px;">Nenhum vinil disponível nessa categoria 😢</h2>
