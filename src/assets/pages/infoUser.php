...
// BUSCAR TELEFONE
$sqlTel = mysqli_query($con, "
    SELECT numero_usuario 
    FROM telefones 
    WHERE usuario_id = $usuario_id 
    LIMIT 1
");
$telefone = mysqli_fetch_assoc($sqlTel);
$telefone = $telefone ? $telefone['numero_usuario'] : "Não informado";

// BUSCAR ENDEREÇO
$sqlEnd = mysqli_query($con, "
    SELECT Logradouro, CEP, complemento, Cidade, Estado 
    FROM enderecos 
    WHERE usuario_id = $usuario_id
    LIMIT 1
");
$endereco = mysqli_fetch_assoc($sqlEnd);
?>
...
<body>
    ...
    <section class="fundoPrincipal">
        <main>
            ...
            <div class="secoesUser">
                <a href="/VinilDeRua-main/vinil de rua/src/assets/pages/infoUser.php">Informações Pessoais</a>
                <a href="/VinilDeRua-main/vinil de rua/src/assets/pages/carrinho.php">Carrinho</a>
                <a href="/VinilDeRua-main/vinil de rua/src/assets/pages/favorito.php">Favoritos</a>
                <a href="/VinilDeRua-main/vinil de rua/src/assets/pages/minhasCompras.php">Minhas Compras</a>
            </div>
            ...
            <section class="cardsInfos">
                ...
                <div class="cardInfoUser">
                    ...
                    <?php if ($endereco): ?>
                        <p><?= htmlspecialchars($endereco['Logradouro']) ?></p>
                        <p><?= htmlspecialchars($endereco['CEP']) ?></p>
    ...
    <script src="/VinilDeRua-main/vinil de rua/src/assets/scripts/carrinho.js"></script>
    <script src="/VinilDeRua-main/vinil de rua/src/assets/scripts/conexão.js"></script>
